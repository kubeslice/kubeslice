...
{{- define "imagePullSecrets.secretName" -}}
    {{- if .Values.global.nsm_docker_existingImagePullSecret -}}
        {{- printf "%s" (tpl .Values.global.nsm_docker_existingImagePullSecret $) -}}
    {{- else -}}
...
{{- if (not .Values.global.nsm_docker_existingImagePullSecret) }}
    {{- true -}}
{{- end -}}
{{- end -}}
