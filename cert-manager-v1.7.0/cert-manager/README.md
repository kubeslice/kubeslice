...
$ helm install my-release --namespace cert-manager --version v1.7.0 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.7.0/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.7.0` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.7.0` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.7.0` |
